...
export default function Home() {
  return (
    <main className="bg-slate-300 h-screen flex justify-center items-center p-5">
      <div className="bg-white w-full shadow-lg p-5 rounded-xl">
        ...
        <div className="my-2 flex items-center gap-2">
          <span className="bg-green-400 text-white uppercase px-2 py-1.5 text-xs font-medium rounded-full">
            Today
          </span>
